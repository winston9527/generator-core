...
public class FreemarkerUtil {
     ...
     * @param outFile
     */
    public static void fprint(String name,Map<String, Object> root,String path,String outFile) {
        ...
        try {
            ...
            OutputStreamWriter out2 = new OutputStreamWriter(new FileOutputStream(path+outFile),"UTF-8");
            Template temp = getTemplate(name);
